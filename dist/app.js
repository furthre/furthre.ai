...
var _facebookStep = require("./steps/stepTwo/facebookStep");
var _youtubeStep = require("./steps/stepTwo/youtubeStep");
var _tiktokStep = require("./steps/stepTwo/tiktokStep");
var _instagramStep = require("./steps/stepTwo/instagramStep");
var _pinterestStep = require("./steps/stepTwo/pinterestStep");
var _linkedinStep = require("./steps/stepTwo/linkedinStep");
var _twitterStep = require("./steps/stepTwo/twitterStep");
...
var _progressBar = require("./utils/progressBar"); // <-- Import
function initSocialMediaGenerator() {
    (0, _core.onReady)(()=>{
        ...
        (0, _progressBar.initProgressBar)(slider, false);
    });
}

},{"@xatom/core":"j9zXV","./utils/sliderUtils":"h4Mtj","./steps/stepOne":"lvyUW","./steps/stepTwo/facebookStep":"aQHNJ","./steps/stepTwo/youtubeStep":"jseHC","./steps/stepTwo/tiktokStep":"hU0I2","./steps/stepTwo/instagramStep":"fX1oD","./steps/stepTwo/pinterestStep":"geCy4","./steps/stepTwo/linkedinStep":"1WzN0","./steps/stepTwo/twitterStep":"eIRRO","./steps/stepThree":"312Tb","./steps/stepFour":"kCaib","./steps/stepFive":"fCsu8","./steps/stepSix":"gf6Ep","./utils/formUtilities":"bYmin","./utils/progressBar":"h8O5A","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"h4Mtj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "isSlideInactive", ()=>isSlideInactive);
 ...
 */ parcelHelpers.export(exports, "getTotalActiveSlides", ()=>getTotalActiveSlides);
/**
 * Returns the current slide's 1-based position among active slides.
 */ parcelHelpers.export(exports, "getActiveSlideIndexAmongActive", ()=>getActiveSlideIndexAmongActive);
...
const initStepThree = (slider)=>{
    ...
    submitButton.on("click", ()=>{
        ...
        const description = descriptionInput.getElement().value.trim();
        if (!description) {
...
const initAdditionalInstructionsStep = (slider)=>{
    const form = new (0, _core.WFFormComponent)("#socialMediaGenerator");
    ...
    submitButton.on("click", (event)=>{
        ...
        // Get the entered additional instructions (can now be empty)
        const instructions = instructionsInput.getElement().value.trim();
        // Clear any error state (we are allowing empty instructions now)
        errorElement.setText("");
        errorElement.setStyle({
            display: "none"
        });
        // Store the additional instructions in localStorage, even if empty
        (0, _formUtilities.updateFormData)({
        ...
        submitFinalButton.on("click", ()=>{
            ...
            postFormData.onData((response)=>{
                if (response.content) {
                    ...
                    if (response.content.twitter_content) sections.push(`<h1>X</h1>${response.content.twitter_content}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"h8O5A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
function initProgressBar(slider, showAsPercentage = false) {
    const progressBar = new (0, _core.WFComponent)("#progress-bar");
    const progressText = new (0, _core.WFComponent)("#progress-percentage");
    /**
   * Recalculate and update the progress bar width and text
   */ function updateProgress() {
        // Get the total number of active slides (i.e., not data-inactive)
        const totalActive = (0, _sliderUtils.getTotalActiveSlides)(slider);
        // Get the user's current position among those active slides
        const activePosition = (0, _sliderUtils.getActiveSlideIndexAmongActive)(slider);
        ...
        if (showAsPercentage) // "XX%" style
        progressText.setText(`${percent}%`);
        else // "Step X of Y" style
...
},{"@xatom/core":"j9zXV","./sliderUtils":"h4Mtj","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"9MwTU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initializePropertyDescriptionGenerator() {
    (0, _core.onReady)(()=>{
        ...
        const { completeProgress } = (0, _progressBar.initProgressBar)(slider);
    });
}

},{"./utils/sliderUtils":"l6xx5","./steps/stepOne":"7xdwN","./steps/stepTwo":"f41a8","./steps/stepThree":"7xjKl","@xatom/core":"j9zXV","./utils/formUtils":"88BvI","./utils/progressBar":"3YTiB","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"l6xx5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Initialize the slider
parcelHelpers.export(exports, "initializeSlider", ()=>initializeSlider);
...
const initStepOne = ()=>{
    ...
    const addressElement = addressInput.getElement();
    const squareFootageElement = squareFootageInput.getElement();
    const lotSizeElement = lotSizeInput.getElement();
    const bedroomsElement = bedroomsInput.getElement();
    const bathroomsElement = bathroomsInput.getElement();
...
const initStepThree = ()=>{
    ...
    submitButton.on("click", (event)=>{
        ...
        if (!otherFeatures || !interiorDescription || !renovations || !favoriteThing || !coolFeature || !vibe || !outdoorSpace || !idealFor) {
            errorElement.setText("Please fill out all fields.");
            errorElement.setStyle({
                display: "block"
            });
...
},{"@xatom/core":"j9zXV","../utils/formUtils":"88BvI","../utils/sliderUtils":"l6xx5","../../../api/apiConfig":"7VxA0","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"3YTiB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
function initProgressBar(slider) {
    const progressBarElement = new (0, _core.WFComponent)("#progress-bar");
    const progressTextElement = new (0, _core.WFComponent)("#progress-percentage");
...
},{"@xatom/core":"j9zXV","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"isk5z":[function(require,module,exports) {
// main.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _formUtils = require("./utils/formUtils");
var _progressBar = require("./utils/progressBar"); // <-- 1) import the new file
...
},{"@xatom/core":"j9zXV","./utils/sliderUtils":"abPgU","./steps/stepOne":"2HHOi","./steps/stepTwo":"b5NVt","./steps/personalNote":"1sVlx","./steps/businessNews":"2N1G0","./steps/lifeUpdate":"bwxW9","./steps/newListings":"evvzv","./steps/somethingFun":"9FHnX","./steps/testimonials":"fZ99v","./utils/formUtils":"l2Aqw","./utils/progressBar":"eWZhf","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"abPgU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Initialize the slider
parcelHelpers.export(exports, "initializeSlider", ()=>initializeSlider);
...
},{"@xatom/core":"j9zXV","../utils/sliderUtils":"abPgU","../utils/formUtils":"l2Aqw","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"eWZhf":[function(require,module,exports) {
 ...
 */ function getActiveSlidePosition(slider) {
    const allSlides = slider.getAllSlides();
    const currentIndex = slider.getActiveSlideIndex();
    // Build an array of active slide indices
    const activeIndices = [];
...
function initProgressBar(slider, showAsPercentage = false) {
    const progressBarElement = new (0, _core.WFComponent)("#progress-bar");
    const progressLabelElement = new (0, _core.WFComponent)("#progress-percentage");
    /**
   ...
   */ function updateProgress() {
        ...
        if (showAsPercentage) // Show "XX%"
        progressLabelElement.setText(`${percent}%`);
        else // Show "Step X of Y"
...
},{"@xatom/core":"j9zXV","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"d3eQl":[function(require,module,exports) {
// main.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _progressBar = require("./utils/progressBar"); // <-- import our new file
...
},{"./utils/sliderUtils":"8jEmz","./utils/formUtils":"lfimo","@xatom/core":"j9zXV","./steps/stepOne":"B9w2U","./steps/stepTwo":"6qHlW","./steps/stepThree":"ewjfG","./steps/stepFour":"030LT","./steps/stepFive":"6o0C2","./steps/stepSix":"kLiEE","./steps/stepSeven":"e1tb5","./steps/stepEight":"eugxt","./steps/stepNine":"3oHNZ","./steps/stepTen":"bh5JA","./steps/stepEleven":"hBAgr","./steps/stepTwelve":"7ki1M","./utils/progressBar":"jRQgq","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"8jEmz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Initialize the slider
parcelHelpers.export(exports, "initializeSlider", ()=>initializeSlider);
...
},{"@xatom/core":"j9zXV","../utils/formUtils":"lfimo","../utils/sliderUtils":"8jEmz","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"jRQgq":[function(require,module,exports) {
// utils/progressBar.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
function initProgressBar(slider, showAsPercentage = false) {
    const progressBar = new (0, _core.WFComponent)("#progress-bar"); // The filling element
    const progressText = new (0, _core.WFComponent)("#progress-percentage"); // The text element
...
},{"@xatom/core":"j9zXV","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"kzyKZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../../api/apiConfig":"7VxA0","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"9dEMs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../authConfig":"66ric","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"6pfYE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../auth/authConfig":"66ric","@xatom/core":"j9zXV","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"jDtnH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../api/apiConfig":"7VxA0","../auth/authConfig":"66ric","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"48Xdq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../auth/authConfig":"66ric","../api/apiConfig":"7VxA0","@parcel/transformer-js/src/esmodule-helpers.js":"lV7RN"}],"8zu0B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
